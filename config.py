#THE LAST CHANGE FOR TESTING GIT WORKING>
...
#my stuff
autostarter = [
    "picom -b",          # Start picom for compositing
    "nitrogen --restore", # Restore the last set wallpaper with nitrogen
    "nm-applet", 
    "xfce4-clipman",         # Start the network manager applet (as an example)
]
